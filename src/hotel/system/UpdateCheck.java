...
public class UpdateCheck extends JFrame implements ActionListener{
    ...
    UpdateCheck(){
        ...
        JLabel lblpending=new JLabel("Pending Status");
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        else if(ae.getSource()==update)
        {
            ...
            try{
                Conn c= new Conn();
                c.s.executeUpdate("update customer set room = '"+room+"', name ='"+name+"', checkin = '"+checkin+"', deposite = '"+deposit+"' where number = '"+number+"'");
