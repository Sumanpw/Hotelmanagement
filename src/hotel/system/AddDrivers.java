...
public class AddDrivers extends JFrame implements ActionListener{
    ...
    AddDrivers()
    {
        ...
        lblroom.setBounds(60,60,120,30);
        add(lblroom);
        
        tfname=new JTextField();
        tfname.setBounds(200,65,150,30);
        add(tfname);
        
        JLabel lblage=new JLabel("Age");
        lblage.setFont(new Font("Tahima",Font.PLAIN,16));
       ...
       add(gendercombo);
        ...
        lblavailable.setFont(new Font("Tahima",Font.PLAIN,16));
       ...
       lbllocation.setFont(new Font("Tahima",Font.PLAIN,16));
       ...
       Image l2 = i1.getImage().getScaledInstance(500, 300, Image.SCALE_DEFAULT);
       ImageIcon i3= new ImageIcon(l2);
        ...
        if(ae.getSource()==add)
        {
            ...
            String location= tflocation.getText();
             ...
             try{
                 ...
                 JOptionPane.showMessageDialog(null, "New added sucessfully");
                 setVisible(false);
